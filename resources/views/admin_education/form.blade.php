                    ...
                    <div class="grid">
                        <div>
                           ...
                           <div class="form-group">
                            ...
                            <input type="text" class=" styled-inputtext" value="" id="education_hy" placeholder="" name="education_hy" value="{{old('education_hy')}}" autocomplete="off">    
                            </div>
                            <div class="form-group">
                            <label class="control-label " for="education_ru">Կրթություն (ру)</label>
                                    <input type="text" class=" styled-inputtext" value="" id="education_ru" placeholder="" name="education_ru" value="{{old('education_ru')}}" autocomplete="off">
                            </div>
                            <div class="form-group">
                            <label class="control-label " for="education_en">Կրթություն (en)</label>
                                    <input type="text" class=" styled-inputtext" value="" id="education_en" placeholder="" name="education_en" value="{{old('education_en')}}" autocomplete="off">
                            </div>
                           </div>
                        </div>
                    </div>
